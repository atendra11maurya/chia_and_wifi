...
export const EXPERIENCE_DATA: ExperienceItem[] = [
  ...
  {
    id: "synopsys-engr-1",
    role: "A&MS Layout Design Engineer I",
    company: "Synopsys Inc",
    companySlug: "synopsys",
    location: "Bengaluru, Karnataka, India",
    ...
    isCurrent: false,
    type: "Full-time",
    summary: "Developed custom layout topologies and executed comprehensive physical verification for standard cell libraries and custom cells.",
    highlights: [
      "Designed standard cell layouts (Logic, Sequential, Power Management, Level Shifters) in 12nm and 22nm process nodes.",
      "Conducted thorough DRC, LVS, and ERC debugging using Cadence Virtuoso Layout Editor and IC Validator.",
      "Collaborated on cell architecture exploration to optimize track heights and pin placement for place-and-route engines.",
      "Authored QA documentation and sanity test checks for library releases."
    ],
    keyTools: ["Cadence Virtuoso", "Custom Compiler", "StarRC", "Calibre"],
    keyNodes: ["12nm", "22nm"]
  },
  {
    id: "synopsys-intern",
    ...
    isCurrent: false,
    type: "Internship",
    summary: "Intensive technical internship focusing on custom circuit layout design fundamentals, DRC/LVS debugging, and script-based layout automation.",
    highlights: [
      "Mastered custom layout techniques in Cadence Virtuoso and Synopsys tool suites.",
      "Assisted senior engineers in standard cell DRC/LVS cleanup and parasitic extraction.",
      "Created Linux Bash shell scripts for streamlining repetitive file conversion and verification tasks."
    ],
    keyTools: ["Cadence Virtuoso", "Linux Shell", "Calibre DRC"],
    keyNodes: ["22nm"]
  },
  {
    id: "pine-academy",
    role: "ASIC Layout & Design Trainee",
    ...
    isCurrent: false,
    type: "Trainee",
    summary: "Comprehensive 1-year practical training program covering ASIC full custom layout design, Linux Bash/Tcl scripting, and Verilog digital design.",
    highlights: [
      "Completed rigorous hands-on training in ASIC Full Custom Layout & Design methodologies.",
      "Developed custom scripts in Bash Scripting & Tcl for Linux EDA environments.",
      "Studied digital CMOS circuit fundamentals and Verilog HDL design."
    ],
    keyTools: ["Linux Bash", "Tcl", "Verilog HDL", "Cadence Virtuoso Tools"],
    keyNodes: ["Planar CMOS"]
  },
  {
    id: "bhel",
    ...
    isCurrent: false,
    type: "Internship",
    summary: "Industrial engineering internship exploring power electronics systems, electrical control hardware, and industrial automation.",
    highlights: [
      "Gained practical exposure to large-scale industrial electrical hardware and control systems.",
      "Studied industrial power management circuit diagrams and safety protocols."
    ],
    keyTools: ["Industrial Power Systems", "Circuit Diagrams"],
    keyNodes: ["Power Systems"]
  }
];
