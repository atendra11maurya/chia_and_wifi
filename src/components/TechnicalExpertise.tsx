...
export const TechnicalExpertise: React.FC = () => {
  return (
    <section id="expertise" className="py-24 bg-[#F8F9FB] border-t border-gray-200/80">
              ...
              >
                <div>
                  ...
                  <div className="flex items-center gap-3.5 mb-4">
                    <div className="w-11 h-11 rounded-xl bg-white border border-gray-200 text-[#0F62FE] flex items-center justify-center shadow-2xs group-hover:bg-[#0F62FE] group-hover:text-white group-hover:scale-105 transition-all duration-300 ease-out">
                      <IconComponent className="w-5 h-5 group-hover:scale-110 transition-transform duration-300 ease-out" />
                    </div>
